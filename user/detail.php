...
?>
    ...
    <div class="container-fluid pb-5">
        <div class="row px-xl-5">
            ...
            <img class="w-100 h-100" src="../Admin/images/products/<?php echo $pimg2; ?>" alt="Image">
            </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h3 class="font-weight-semi-bold mb-4">$<?php echo $pprice2; ?></h3>
                    <p class="mb-4"><?php echo $pdesc2; ?></p>
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <a class="btn btn-primary px-3" href="checkout.php?did=<?php echo $pid2; ?>"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="bg-light p-30">
                    ...
                    <div class="tab-content">
                        ...
                        <?php  
                            ...
                            $re_text=$row['review_text'];
                        ?>
                                    <div class="media mb-4">
                                        <img src="img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
                                        <div class="media-body">
                                            <h6><?php echo $cus_name; ?><small> - <i>01 Jan 2045</i></small></h6>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form method="post">
                                        <div class="form-group">
                                            ...
                                            <textarea id="message" cols="30" rows="5" class="form-control" name="rev"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="name">Your Name *</label>
                                            <input type="text" class="form-control" id="name" name="rname">
                                        </div>
                                        <div class="form-group">
                                            <label for="email">Your Email *</label>
                                            <input type="email" class="form-control" id="email" name="remail">
                                        </div>
                                        <div class="form-group mb-0">
                                            <input type="submit" value="Leave Your Review" class="btn btn-primary px-3" name="submitr">
                                        </div>
                                    </form>
                                </div>
                            </div>
...
<?php
    if(isset($_POST["submitr"]))
    {
      ...
      if($revid=='')
      {
        $sql = mysqli_query($conn,"INSERT INTO review(customer_name, customer_mail, review_text ) 
                                                VALUES ('$r_name','$r_mail','$r_text')");
      }
      else
      {
        $sql = mysqli_query($conn,"UPDATE review SET customer_name='$r_name', customer_mail='$r_mail', review_text='$r_text' where review_id='$revid' " );
      }
