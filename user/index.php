                ...
                <div class="product-item bg-light mb-4"  style="border-radius: 10px;">
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            ...
                            <a class="btn btn-outline-dark btn-square" href="shop.php"><i class="far fa-heart"></i></a>
                    ...
                    <div class="text-center py-4">
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            ...
                            <h6 class="text-muted ml-2"><del>$<?php echo ($p_price +250); ?></del></h6>
                        </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href="cart.php?cid=<?php echo $p_id; ?>"><i class="fa fa-shopping-cart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href="cart.php"><i class="far fa-heart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href="detail.php?id=<?php echo $p_id; ?>"><i class="fa fa-search"></i></a>
                        </div>
                    </div>
                    <div class="text-center py-4">
