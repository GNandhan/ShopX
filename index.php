...
<head>
    ...
    <!-- Favicon -->
    <link href="user/img/icono.png" rel="icon">
        ...
        <div class="row bg-secondary py-1 px-xl-5">
            <div class="col-lg-6 d-none d-lg-block">
                <div class="d-inline-flex align-items-center h-100">
                    ...
                    <a class="text-body mr-3" href="user/contact.php">Contact</a>
            ...
            <div class="col-lg-6 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        ...
                        <a href="user/customer_reg.php"><button class="dropdown-item" type="button">Sign up</button></a>
                            <a href="user/customer_login.php"><button class="dropdown-item" type="button">Login</button></a>
                        </div>
                    </div>
                </div>
                ...
                <a class="text-decoration-none" href="">
                    <div class="cat-item d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="Admin/images/category/<?php echo $catimg; ?>" alt="">
                        </div>
                ...
                <div class="product-item bg-light mb-4"  style="border-radius: 10px;">
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href="user/customer_login.php"><i class="fa fa-shopping-cart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href="user/customer_login.php"><i class="far fa-heart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href="user/detail.php"><i class="fa fa-search"></i></a>
                        </div>
                    </div>
